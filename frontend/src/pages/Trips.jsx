...
import { Plus, Search, Edit2, Play, CheckCircle2, XCircle, FileText, Download, Compass } from 'lucide-react';
      ...
      <div className="card">
        {loading ? (
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '3rem', gap: '1rem' }}>
            <Compass size={48} style={{ color: 'var(--text-secondary)', opacity: 0.5 }} />
            <h3 style={{ fontSize: '1.125rem', fontWeight: 600 }}>No trips found</h3>
            <p style={{ color: 'var(--text-secondary)', fontSize: '0.875rem', textAlign: 'center', maxWidth: '300px' }}>
              Plan a new route, assign an available driver and vehicle, and start dispatching trips.
            </p>
            <button className="btn btn-primary" onClick={handleOpenCreateModal}>
              <Plus size={16} />
